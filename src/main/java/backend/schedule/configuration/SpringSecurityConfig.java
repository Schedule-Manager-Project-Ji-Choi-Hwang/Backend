...
public class SpringSecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(Arrays.asList("http://localhost:19006", "exp://192.168.0.106:8081", "exp://192.168.0.7:8081"));
...
//                .requestMatcher(notRefreshEndpoint)
                .authorizeRequests()
                .antMatchers("/member/sign-up", "/member/log-in", "/member/refresh", "/member/find-loginId", "/member/find-password", "/study-board").permitAll()
