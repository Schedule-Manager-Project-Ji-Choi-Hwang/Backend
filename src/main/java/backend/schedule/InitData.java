...
//        initDataService.init();
    ...
    static class InitDataService {
        ...
        public void init() {
            ...
            // 멤버 4의 대량 스터디 게시글 등록
            for (int i = 0; i < 100; i++) {
                StudyPost initStudyPost = new StudyPost("테스트공부(스터디)" + i, FieldTag.개발, 20, false, Area.부산, "테스트용 스터디 입니다. 가입 탈퇴 자유!!");
            ...
            StudyPost testStudyPost1 = new StudyPost("정보처리기사(스터디)", FieldTag.개발, 20, false, Area.경기, "부산 정처기 스터디입니다. 부산사람 환영");
            ...
            StudyPost testStudyPost2 = new StudyPost("AWS 자격증(스터디)", FieldTag.개발, 15, true, Area.경상남도, "AWS 자격증 스터디입니다. 경험자 환영");
            ...
            StudyPost testStudyPost3 = new StudyPost("코딩 테스트(스터디)", FieldTag.개발, 5, false, Area.충청북도, "백준 실버3 이상 구해요.");
